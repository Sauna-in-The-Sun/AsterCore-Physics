...
private:
    void integrate(float dt) {
        for (RigidBody* body : bodies) {
            ...
            // Apply forces (gravity + global forces)
    ...
    Vector3 globalForce = Vector3(0, -9.8f, 0); // Default gravity
};
...
int main() {
    ...
    for (int i = 0; i < 120; ++i) {
        ...
        // Print sphere position every 10 frames
        if (i % 10 == 0) {
